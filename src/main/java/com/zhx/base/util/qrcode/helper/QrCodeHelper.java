package com.zhx.base.util.qrcode.helper;
...
import com.zhx.base.util.qrcode.util.QrCodeUtil;
import com.zhx.base.util.qrcode.wrapper.BitMatrixEx;
...
public class QrCodeHelper {
     ...
     * 对 zxing 的 QRCodeWriter 进行扩展, 解决白边过多的问题
     * <p/>
     * 源码参考 {@link com.google.zxing.qrcode.QRCodeWriter#(QRCode, int, int, int)}
     *
     * @param code
     * @param width
     * @param height
